...
defmodule SSE.ConnectionHandler do
  ...
  use GenServer
  require Logger
  alias MCP.Server # Needed for handle_message delegation
  ...
  def handle_cast({:process_message, message}, state) do
    ...
    # Get the actual implementation module (e.g., GraphOS.Protocol.MCPImplementation)
    implementation_module = Application.get_env(:mcp, :implementation_module)
