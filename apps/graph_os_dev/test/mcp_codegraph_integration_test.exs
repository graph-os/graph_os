defmodule GraphOS.Dev.MCPCodeGraphIntegrationTest do
  ...
  test "CodeGraphServer implements required MCP Server callbacks" do
    ...
    callbacks = [
      {:start, 1},                # start/1 takes session_id
      {:handle_message, 2},        # handle_message/2 takes session_id and message
      {:handle_list_tools, 3},     # handle_list_tools/3 takes session_id, request_id, params
      {:handle_tool_call, 4}       # handle_tool_call/4 takes session_id, request_id, params, meta
    ]
