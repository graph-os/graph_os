defmodule GraphOS.Dev.CodeGraph do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> GraphOS.Dev.CodeGraph.init()
      :ok
  ...
  ## Examples
      ...
      iex> GraphOS.Dev.CodeGraph.build_graph("lib")
      {:ok, stats}

      iex> GraphOS.Dev.CodeGraph.build_graph("lib", recursive: false)
      {:ok, stats}
  ...
  ## Examples
      ...
      iex> GraphOS.Dev.CodeGraph.get_module_info("GraphOS.Dev.CodeGraph")
      {:ok, module_data}
  ...
  ## Examples
      ...
      iex> GraphOS.Dev.CodeGraph.update_file("lib/my_module.ex")
      {:ok, changes}
