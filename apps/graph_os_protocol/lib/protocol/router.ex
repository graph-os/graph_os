defmodule GraphOS.Protocol.Router do
      ...
      _pid ->
        cond do
          ...
          service == "SystemInfoService" && method == "GetSystemInfo" ->
            ...
            |> put_resp_header("grpc-status", "0") # 0 = OK
          ...
          service == "SystemInfoService" && method == "ListSystemInfo" ->
            ...
            system_info_list = %{
              items: [
                ...
                generate_system_info(%{id: "history-1", timestamp: System.system_time(:second) - 3600}),
                generate_system_info(%{id: "history-2", timestamp: System.system_time(:second) - 7200})
              ]
            }
  ...
  defp generate_system_info(overrides \\ %{}) do
    ...
    base_info = %{
      ...
      memory_free: 6_442_450_944,  # 6GB
      uptime: System.system_time(:second) - System.system_time(:second) + 86400, # 1 day
