defmodule GraphOS.Store.AccessTest do
  @moduledoc """
  Tests for GraphOS.Store.Access behavior.
  ...
  alias GraphOS.Store.{Operation, Transaction, Access}
  ...
  describe "Access behavior" do
    ...
    test "defines required callbacks" do
      ...
      assert function_exported?(GraphOS.Store.Access, :behaviour_info, 1)
  ...
  describe "Mock implementation" do
    ...
    defmodule MockAccess do
      @behaviour GraphOS.Store.Access
    ...
    test "can implement all callbacks" do
      ...
      operation = %GraphOS.Store.Operation{type: :get, entity: :node, params: %{id: "node1"}}
      transaction = %GraphOS.Store.Transaction{operations: [operation]}
      topic = "node:123"
