defmodule GraphOS.Store.Schema.Protobuf do
  @moduledoc """
  ...
  ## Examples
      iex> GraphOS.Store.Schema.Protobuf.validate(%{name: "Alice", age: 30}, MyApp.PersonSchema)
  ...
  ## Examples
      ...
      ...> }
      ...> \"\"\"
      iex> GraphOS.Store.Schema.Protobuf.extract_fields_from_proto(proto_def)
  ...
  ## Examples
      ...
      ...> }
      ...> \"\"\"
      iex> GraphOS.Store.Schema.Protobuf.extract_enum_values(proto_def, "Color")
      [:RED, :GREEN, :BLUE]
  """
  @spec extract_enum_values(String.t(), String.t()) :: [atom()]
  def extract_enum_values(proto_def, enum_name)
      when is_binary(proto_def) and is_binary(enum_name) do
  ...
  ## Examples
      ...
      iex> GraphOS.Store.Schema.Protobuf.proto_to_map(proto_message, field_mapping)
      %{name: "Alice", age: 30}
  """
  @spec proto_to_map(map(), map()) :: map()
  def proto_to_map(proto_message, field_mapping)
      when is_map(proto_message) and is_map(field_mapping) do
  ...
  ## Examples
      ...
      iex> field_mapping = %{"name" => :name, "age" => :age}
      iex> GraphOS.Store.Schema.Protobuf.map_to_proto(map, field_mapping)
      %{"name" => "Alice", "age" => 30}
  """
  ...
  def map_to_proto(map, field_mapping) when is_map(map) and is_map(field_mapping) do
    ...
    reverse_mapping =
      Enum.reduce(field_mapping, %{}, fn {proto_key, schema_key}, acc ->
