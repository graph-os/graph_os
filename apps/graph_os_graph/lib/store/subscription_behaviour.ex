defmodule GraphOS.Store.SubscriptionBehaviour do
  @moduledoc """
  ...
  used with GraphOS.Store. It allows components to be notified of graph changes
  ...
  alias GraphOS.Store.{Node, Edge, Operation}
  ...
  """
  @callback broadcast(topic :: String.t(), event :: term()) :: :ok | {:error, term()}
  ...
  - `{:error, reason}` - Failed to unsubscribe
  """
  @callback unsubscribe(subscription_id :: reference()) :: :ok | {:error, term()}
end
