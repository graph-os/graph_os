defmodule GraphOS.GraphContext do
  @moduledoc """
  ...
  alias GraphOS.GraphContext.{Node, Transaction, Query, Store, Algorithm, Subscription}
  ...
  - `opts` - Initialization options
    - `:store_module` - The storage module to use (default: GraphOS.GraphContext.Store.ETS)
    - `:access_control` - Whether to initialize access control (default: true)
    - `:name` - Name for the graph (default: "default")

  ## Examples

      iex> GraphOS.GraphContext.init()
      :ok

      iex> GraphOS.GraphContext.init(access_control: false)
      :ok
  """
  @spec init(keyword()) :: :ok | {:error, term()}
  def init(opts \\ []) do
    store_module = Keyword.get(opts, :store_module, GraphOS.GraphContext.Store.ETS)
  ...
  ## Examples
      ...
      iex> GraphOS.GraphContext.query(start_node_id: "person1", edge_type: "knows")
      {:ok, [%Node{id: "person2", ...}, ...]}
  """
  ...
  ## Examples
      ...
      iex> GraphOS.GraphContext.execute(transaction)
      {:ok, result}
  """
  ...
  ## Examples
      ...
      iex> GraphOS.GraphContext.bfs("person1")
  ...
  ## Examples
      ...
      iex> GraphOS.GraphContext.shortest_path("person1", "person5")
  ...
  ## Examples
      ...
      iex> GraphOS.GraphContext.connected_components()
  ...
  ## Examples
      ...
      iex> GraphOS.GraphContext.pagerank()
  ...
  ## Examples
      ...
      iex> GraphOS.GraphContext.minimum_spanning_tree()
      {:ok, [%Edge{...}, ...], 42.5}
  """
  ...
  ## Examples
      ...
      iex> GraphOS.GraphContext.subscribe_to_node("node1")
  ...
  ## Examples
      ...
      iex> GraphOS.GraphContext.subscribe_to_edge("edge1")
      {:ok, #Reference<0.123.456.789>}
  """
  ...
  ## Examples
      ...
      iex> GraphOS.GraphContext.subscribe_to_graph()
      {:ok, #Reference<0.123.456.789>}
  """
  ...
  ## Examples
      ...
      iex> {:ok, id} = GraphOS.GraphContext.subscribe_to_node("node1")
      iex> GraphOS.GraphContext.unsubscribe(id)
      :ok
  """
  ...
  defp subscription_module do
    Application.get_env(:graph_os_graph, :subscription_module, GraphOS.GraphContext.Subscription.NoOp)
  end
end
