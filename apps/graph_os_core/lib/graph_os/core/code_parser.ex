defmodule GraphOS.Core.CodeParser do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> GraphOS.Core.CodeParser.parse_file("lib/my_module.ex")
  ...
  ## Examples
      ...
      iex> GraphOS.Core.CodeParser.parse_string(source)
      {:ok, ast}
  ...
  ## Examples
      ...
      ...>   end
      ...> end
      iex> GraphOS.Core.CodeParser.process_ast(ast, "my_module.ex")
